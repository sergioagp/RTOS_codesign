...
HD_PWD='C:/Users/sergiopereira/Vivado_projects/RTOS_codesign/projects/project_rtos/project_rtos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_rtos_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_rtos_wrapper.tcl
