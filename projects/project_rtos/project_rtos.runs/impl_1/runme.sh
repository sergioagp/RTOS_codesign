...
HD_PWD='C:/Users/sergiopereira/Vivado_projects/RTOS_codesign/projects/project_rtos/project_rtos.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_rtos_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_rtos_wrapper.tcl -notrace
