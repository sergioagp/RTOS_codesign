...
#
# Generated by export_simulation on Tue Jul 10 13:46:08 +0100 2018
#
################################################################################
...
'-reset_run' switch to the './design_rtos.sh' script.

./design_rtos.sh -reset_run
...
./design_rtos.sh -noclean_files

For more information on the script, please type './design_rtos.sh -help'.
