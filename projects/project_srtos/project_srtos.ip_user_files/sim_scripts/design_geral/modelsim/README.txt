...
#
# Generated by export_simulation on Wed Jul 11 00:32:58 +0100 2018
#
################################################################################
...
'-reset_run' switch to the './design_geral.sh' script.

./design_geral.sh -reset_run
...
./design_geral.sh -noclean_files

For more information on the script, please type './design_geral.sh -help'.
