...
HD_PWD='C:/Users/sergiopereira/Vivado_projects/RTOS_codesign/projects/project_srtos/project_srtos.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_geral_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_geral_wrapper.tcl -notrace
