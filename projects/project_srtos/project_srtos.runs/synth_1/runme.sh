...
HD_PWD='C:/Users/sergiopereira/Vivado_projects/RTOS_codesign/projects/project_srtos/project_srtos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_geral_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_geral_wrapper.tcl
