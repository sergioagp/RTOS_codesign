...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=softfp -nostartfiles -g -Wall -Wextra
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = scheduler
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = scheduler_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = timers_ip
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = timers_ip_0
END
